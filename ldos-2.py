        ...
        while 1 == 1:
            ...
            if command == "break":
                ...
                if ".wav" in command:
                    ...
                    f = open(c, "r")
                    print(f.read())
                elif ".jpg" in command or ".png" in command or ".gif" in command or ".jpeg" in command:
...
calc - Opens calculator""")
              ...
              webbrowser.open("https://www.google.com")
                ...
                print("What's new with L-DOS 2.1?")
                time.sleep(0.5)
                print("Oh, you actually want to know? Well here you go.")
                input("First of all, the md command returns.")
                input("Second, music maker is in the F-SHOP.")
                input("Finally, you can view an image of Robo, our mascot using the new")
                input("image viewer (uses actual image viewer included with your Windows")
                input("system, sorry...")
                winsound.Beep(2000, 250)
